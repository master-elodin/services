...
style.type = 'text/css';
style.innerHTML = [    '.data-block--application { padding-left: 30px; } .data-row.data-row--application { padding-left: 30px; } ',
